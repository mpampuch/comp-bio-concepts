...
# ╔═╡ 0eb824e4-4302-40a1-b128-0f1ff0492726
@code_typed rand(1:10)
...
# ╔═╡ 4090324f-d2ba-411b-b3a8-24ba80fd37bd
@code_warntype sum([1,2,3])
...
# ╔═╡ 7c2ab724-43a1-4df9-adec-e9225156889e
begin
	x = zeros(Int, 100)
	Int(length(x) / 2 - 10)
	Int(length(x) / 2 + 10)
	# length(40:60) - length(x) - 10
	# x[40:60] .= 20
end
...
# ╔═╡ 7359fb23-1880-41f3-a5df-8206e5e42c49
getfield(philip_pixel, :r)

# ╔═╡ 0b8f43c7-c36f-4492-ace1-aa161160778c
philip_pixel.r
...
function get_reds(image::AbstractMatrix)
	# your code here!
	return [get_red(pixel) for pixel in image]  # creates a matrix of same height & width
end
...
# ╔═╡ f3c4c402-0049-4b7b-bca4-f30a0bb53f68
philip_head_reds = get_reds(philip_head)

# ╔═╡ 25c18ce7-c4bc-4e36-ab09-e73399ecb817
[value_as_color(value) for value in philip_head_reds]
...
# ╔═╡ 7b229743-ea1c-455e-b724-6fe87ad52186
mean(get_reds(philip))

# ╔═╡ f6898df6-ee07-11ea-2838-fde9bc739c11
function mean_color(image)
	# your code here!
	reds_mean = mean(get_reds(image))
	greens_mean = mean(get_greens(image))
	blues_mean = mean(get_blues(image))
	return RGB(reds_mean, greens_mean, blues_mean)
end
...
philip_inverted = [invert(pixel) for pixel in philip] # replace `missing` with your code!
...
function quantize(image::AbstractMatrix)
	# your code here!
	return [quantize(pixel) for pixel in image]
end
...
noisify(0.5, 0.60) # edit this test case!
...
manifest_format = "2.0"
project_hash = "ca9c3fa18550abadba656d5613be0e2bab32623b"
